...
class BO_Optimizer(object, metaclass=abc.ABCMeta):
    ...
    # returns Tuple[float, Configuration]
    def get_suggestion(self, history_container: HistoryContainer, return_list=False, compact_space=None):
        ...
        if self.optimization_strategy == 'bo':
            ...
            # type ChallengerList, see `ei_optimization.py` for class ChallengerList
            # where ChallengerList.challengers is a list of ConfigSpace.Configuration objects
            # see https://automl.github.io/ConfigSpace/main/
