...
class DBTuner:
    def __init__(self, args_db, args_tune, env):
        ...
        self.space_transfer = None if 'space_transfer' in self.args_tune else eval(self.args_tune['space_transfer'])
        self.auto_optimizer = None if 'auto_optimizer' in self.args_tune else eval(self.args_tune['auto_optimizer'])
